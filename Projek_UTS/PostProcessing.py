...
class PostProcessing:
    ...
    tissue = 1
    bone = 2
    def __init__(self, model_path, data_path, loss = 'categorical_crossentropy', device = "cpu"):
    ...
    def read_dataset(self):
        image_list = sorted(os.listdir(self.data_path+'/images'))
        label_list = sorted(os.listdir(self.data_path+'/labels'))

        self.train_images = image_list[:120]
        self.val_images =  image_list[120:140]
        self.test_images =  image_list[140:150]
        self.train_labels = label_list[:120]
        self.val_labels = label_list[120:140]
        self.test_labels = label_list[140:150]
        
        #self.test_filenames = self.test_images + self.test_labels
        #self.val_filenames = self.val_images + self.val_labels
